...
alias favi='cp ~/code/david_runger/public/favicon.ico ./'
...
alias gemd='cd  ~/.rbenv/versions/3.2.0/lib/ruby/gems/3.2.0/gems/'
alias gemdg='cd  ~/.rbenv/versions/3.2.0/lib/ruby/gems/3.2.0/bundler/gems'
